    ...
    <>
      <section className="band">
        <div className="grid rise">
          <div className="col-12"><span className="label">프로덕트 디자이너 사전 과제 · 2026.09.14 — 09.18</span></div>
          <div className="col-8">
            <h1>심사하는 동안 규칙이 바뀌어도,<br />고객이 본 조건 그대로 심사되게</h1>
          </div>
          <div className="col-5 hero-sub">
            <p className="lead">
              제보를 받아 리워드를 주는 이벤트에서, 심사 대기 중에 정책이 바뀌면 고객은 제출할 때 본 것과 다른 돈을 받습니다.
      ...
      <section className="band">
        <div className="grid">
          <div className="col-4"><span className="label">문제</span><h2>기준이 둘이면<br />누가 성실해도 갈린다</h2></div>
          <div className="col-7">
            <p>정책은 이벤트 도중에 바뀌고 제출과 지급 사이에는 수일에서 수주가 걸립니다. 그 사이에 금액이 내려가면 고객은 제출할 때 본 것과 다른 돈을 받습니다.</p>
            <p>심사자도 곤란합니다. 이 제보가 어느 시점 기준인지 확인할 방법이 마땅치 않아 지금 값으로 판단하게 됩니다. 겉으로는 금액 분쟁이지만 실제로는 <strong>하나의 제보에 두 개의 기준이 존재할 수 있다는 것</strong>이 문제입니다.</p>
          </div>
        </div>
      </section>
