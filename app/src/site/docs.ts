...
export const SHOTS = [
  ...
  { file: '05-done.png', label: '완료', cap: '확정 후에는 금액과 한도가 잠긴다. 자동 재계산이 없다는 사실을 화면이 말한다.' },
  { file: '06-dup-zero.png', label: '중복 · 0원', cap: '결과와 지급이 다른 축이라는 것이 여기서 드러난다. 중복으로 판정돼 지급은 해당 없음이 되고 사유가 괄호로 남는다.' },
  { file: '07-policy.png', label: '정책 현황', cap: '발효 중 버전과 이력을 한 화면에. 지금 무엇이 적용되는지가 기준점이다.' },
  { file: '08-impact.png', label: '영향 확인', cap: '발행 전 마지막 게이트. 세 숫자를 분리하고, 변경 항목에 해당하는 건이 이번 변경으로 줄지 않는다고 말한다.' },
  { file: '09-empty.png', label: '빈 상태', cap: '왜 비었는지와 다음에 할 수 있는 일을 함께 적는다.' },
];
